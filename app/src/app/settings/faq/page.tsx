...
const FAQ: { q: string; a: string }[] = [
  {
    q: "혼잡도는 어떻게 계산하나요?",
    a: "현장에서 센 실제 인원이 아니라 공개 통계를 학습해 예측한 값입니다. 한국관광 데이터랩에 쌓인 관광지 검색 수요와 기상 데이터를 학습해 관광지별 수요를 예측하고, 여기에 시간대별 방문 패턴을 결합해 산출합니다.",
  },
  {
    q: "실제 상황과 다를 수 있나요?",
  ...
  {
    q: "데이터 출처가 어디인가요?",
    a: "관광지 정보의 출처: ⓒ한국관광공사(TourAPI). 상세 화면의 소개·전화·홈페이지는 화면을 열 때마다 한국관광공사 OpenAPI에서 실시간으로 받아옵니다. 수요 데이터는 한국관광 데이터랩, 기상 데이터는 기상청, 지도와 길찾기는 카카오를 이용합니다.",
  },
  {
    q: "길찾기가 안 될 때가 있어요",
