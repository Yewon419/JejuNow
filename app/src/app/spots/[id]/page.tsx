...
export default async function SpotDetailPage({
  ...
  return (
    <main className="mx-auto min-h-dvh max-w-xl pb-32 lg:max-w-6xl">
      ...
      <div className="fixed inset-x-0 bottom-0 z-40">
        <div
          className="mx-auto flex max-w-md items-center gap-3 border-t border-line bg-surface px-5 pt-3 sm:border-x md:max-w-xl lg:max-w-6xl"
