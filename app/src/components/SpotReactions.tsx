...
export function SpotReactions({ spotId }: { spotId: number }) {
  ...
  return (
    <section aria-label="이 곳에 대한 반응" className="flex items-center gap-2">
      ...
      >
        <svg viewBox="0 0 24 24" fill={reaction === "dislike" ? "currentColor" : "none"} stroke="currentColor" strokeWidth={1.8} className="h-5 w-5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25m8.024-9.75c.011.05.028.1.052.148.591 1.2.924 2.55.924 3.977a8.96 8.96 0 0 1-.999 4.125m.023-8.25c-.076-.365.183-.75.575-.75h.908c.889 0 1.713.518 1.972 1.368.339 1.11.521 2.287.521 3.507 0 1.553-.295 3.036-.831 4.398-.306.774-1.086 1.227-1.918 1.227h-1.053c-.472 0-.745-.556-.5-.96a8.95 8.95 0 0 0 .303-.54m-1.02-6.752c-.487.048-.973.088-1.463.121A48.15 48.15 0 0 0 6.633 13.5c-.806 0-1.533.446-2.031 1.08a9.04 9.04 0 0 0-2.861 2.4c-.723.384-1.35.956-1.653 1.715a4.498 4.498 0 0 0-.322 1.672V19.5a.75.75 0 0 0 .75.75 2.25 2.25 0 0 0 2.25-2.25c0-1.152.26-2.243.723-3.218.266-.558-.107-1.282-.725-1.282H14.23c.483 0 .964.078 1.423.23l3.114 1.04" />
        </svg>
        별로예요
      </button>
      <button
